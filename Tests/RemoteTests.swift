...
final class RemoteTests: XCTestCase {
    func testDomain() {
        XCTAssertEqual("", Page.Remote(value: "https://").domain)
        ...
        XCTAssertEqual("hello", Page.Remote(value: "www.hello.com:8080").domain)
        XCTAssertEqual("hello", Page.Remote(value: "www.hello.com:8080/lol").domain)
    ...
    func testSuffix() {
        ...
        XCTAssertEqual(".com", Page.Remote(value: "www.hello.com:8080").suffix)
        XCTAssertEqual(".com", Page.Remote(value: "www.hello.com:8080/lol").suffix)
